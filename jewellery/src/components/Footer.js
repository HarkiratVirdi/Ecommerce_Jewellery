      ...
      <div className="footer__left">
        <div className="footer__left--1">
          <ul className="footer__left--1-list">
            ...
            <Link to="/" className="heading-5--white footer__link">
              Home
            </Link>
            <Link to="/shop" className="heading-5--white footer__link">
              Shop
            </Link>
            <Link to="/about" className="heading-5--white footer__link">
              About
            </Link>
            <Link to="/contact" className="heading-5--white footer__link">
              Contact
            </Link>
            <Link to="/login" className="heading-5--white footer__link">
              Login
            </Link>
          </ul>
        </div>
